<template>
  <div id="NBCEnvironmentalIntervention">
    <div class="left">
      <div id="map2d"></div>
...
<script>
import NBCEnvironmentalIntervention_data from "@/config/NBCEnvironmentalIntervention_data";
import drawtoolproperties from "@/components/echart/drawtoolproperties";
export default {
  components: { drawtoolproperties },
  data() {
    return {
      tableHeader: NBCEnvironmentalIntervention_data.tableHeader,
      table_data: NBCEnvironmentalIntervention_data.table_data,
      tableHeader2: NBCEnvironmentalIntervention_data.tableHeader2,
      // table_data2: NBCEnvironmentalIntervention_data.table_data2,
    ...
    openHB(){
      ...
      if(ws&&socketOpen){
        ...
        　　console.log(e.data);
          if(e.data == "StartHB"){
            console.log(_this);
            _this.map.addanimatCircle([78.7 ,35.8],"map2d")
          } 
        }
      }
    }
